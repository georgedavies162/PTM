...
ini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.primetime/resources/ivue','primetime.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/plugin.video.primetime/resources/ivue','plugin.video.primetime.zip'))
tmpini       =  xbmc.translatePath(os.path.join('special://home/userdata',''))
ivuetarget   =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.ivueguide/resources/ini/plugin.video.primetime'))
def iVueInt():
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("primetime","Copying ini",'', 'Please Wait')
	...
	iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.primetime/resources/ivue','ivuesettings.xml'))
	iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.primetime/resources/ivue'))
	...
	dp = xbmcgui.DialogProgress()
	dp.create("primetime","Copying DB",'', 'Please Wait')
...
def install(name,url):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("primetime","Installing iVue TV Guide...",'', 'Please Wait')
