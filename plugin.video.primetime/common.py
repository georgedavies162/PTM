...
import urllib, urllib2, os, io, xbmc, xbmcaddon, xbmcgui, json, re, time,xbmcplugin,sys,datetime,string,StringIO,logging,random,array,htmllib,xbmcvfs,common,plugintools,base64

AddonID = 'plugin.video.primetime'
